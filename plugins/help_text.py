    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/brokenupdates'),
                    InlineKeyboardButton('Feedback', url='https://t.me/brokenbotsupports')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/brokenupdates'),
